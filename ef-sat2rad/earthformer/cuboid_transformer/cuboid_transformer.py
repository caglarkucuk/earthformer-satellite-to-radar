...
class CuboidTransformerModel(nn.Module):
    ...
    def __init__(self,
        ...
        # initialization mode
        # self.example_input_array = torch.zeros(1, 18, 192, 192, 3)
        self.attn_linear_init_mode = attn_linear_init_mode
        self.ffn_linear_init_mode = ffn_linear_init_mode
        self.conv_init_mode = conv_init_mode
        ...
        #### Initial upsample #####
        # Upsampling is done in an extremely simple way. Possible room for improvement here!
        self.initial_upsample_kucuk_ir = nn.Upsample(size=(H_out, W_out, C_in)) 
        #### ENDOF Initial upsample #####
    ...
    def forward(self, x, verbose=False):
        ...
        #### Need to add another block here to fix resolution of input data! ####
        x = self.initial_upsample_kucuk_ir(x)
        #### ENDOF Need to add another block here to fix resolution of input data! ####
